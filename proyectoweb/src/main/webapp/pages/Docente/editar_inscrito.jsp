...
<body>
<header>
    <div class="logo"><a href="lista_evaluaciones.jsp"><img class="logo-img" src='images/logo_topbar.png' alt="logo"></a></div>
                    ...
                    <div class="card-body" style="padding-left: 35px">
                        ...
                        <div>
                            <div class="form-group" style="padding-right: 1rem">
                                ...
                                <input name="titulo" type="text" class="form-control" id="nombre" value="<%=inscrito.getUsuario().getNombre() + " "+inscrito.getUsuario().getApellidos()%>" disabled readonly>
                            </div>
                        </div>
